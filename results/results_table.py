...
ROWS = [
    ...
    # === block-level: pretraining is not uniformly inert ==================================
    ("block asymmetry", "HRD", "24 seeds", 24, "DSSL, phase block present",
     "AUROC", 0.6896, "random-init 0.6807", 0.0089, "", "",
     "pretraining IMPROVES the phase block", "experiment_readout.py", ""),
    ("block asymmetry", "HRD", "24 seeds", 24, "DSSL, phase block deleted",
     "AUROC", 0.6440, "random-init 0.6985", -0.0545, "", "",
     "and DEGRADES the amplitude block -- the two net out to nothing, which is why the "
     "composed representation looks inert", "experiment_readout.py", ""),
    ("seasonal dose response", "HRD", "runs 1568399/400/401", "",
     "DSSL minus random-init at alpha=0.05", "AUROC delta", -0.0086, "", "", "", "",
     "", "experiment_readout.py", ""),
    ("seasonal dose response", "HRD", "runs 1568399/400/401", "",
     "DSSL minus random-init at alpha=0.5", "AUROC delta", -0.0129, "", "", "", "",
     "", "experiment_readout.py", ""),
    ("seasonal dose response", "HRD", "runs 1568399/400/401", "",
     "DSSL minus random-init at alpha=5.0", "AUROC delta", -0.0498, "", "", "", 0.013,
     "MORE seasonal training makes the representation monotonically WORSE",
     "experiment_readout.py", ""),
    ("phase readout", "HRD", "24 seeds", 24, "cos/sin vs raw atan2, composed",
     "AUROC delta", -0.0062, "raw atan2", -0.0062, "", 0.86,
     "the wrapped-angle readout was not costing anything; question closed",
     "experiment_readout.py", ""),
    ("phase readout", "HRD", "24 seeds", 24, "cos/sin vs raw atan2, phase block alone",
     "AUROC delta", -0.0189, "raw atan2", -0.0189, "", 0.63, "question closed",
     "experiment_readout.py", ""),
    ("week-to-week change", "HRD", "24 seeds", 24,
     "predicting the CHANGE in a person's rhythm", "R2 gain", "", "persistence baseline",
